...
function BrandSection({ name, tagline, description, features, testimonial, ctaUrl, ctaLabel, icon, logo, accentColor, badges, reverse }: BrandSectionProps) {
    return (
        <section id={name.toLowerCase()} className="py-20 md:py-28 border-b border-gray-100 last:border-b-0 scroll-mt-20">
                ...
                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center ${reverse ? "lg:flex-row-reverse" : ""}`}>
                    ...
                    <div className={reverse ? "lg:order-1" : ""}>
                        <div className="relative aspect-square max-w-lg mx-auto">
                            <div className="absolute inset-0 rounded-3xl bg-primary/6 border border-gray-100 overflow-hidden">
                                ...
                                <div className="absolute top-8 left-8 right-8 bottom-8 flex items-center justify-center">
                                    <div className="relative w-full h-full">
                                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-white rounded-2xl shadow-xl border border-gray-100 flex flex-col items-center justify-center z-10">
                                            <Image 
                                                src={logo} 
                                                alt={`${name} logo`}
                                                width={120}
                                            ...
                                            />
                                            <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">{tagline}</span>
                                        </div>
                                        ...
                                        <div className="absolute top-4 left-4 bg-white rounded-xl shadow-md border border-gray-100 p-3 flex items-center gap-2 hover:shadow-lg transition-shadow">
                                            {badges[0].icon}
                                            <span className="text-xs font-semibold text-primary">{badges[0].label}</span>
                                        </div>
                                        <div className="absolute top-4 right-4 bg-white rounded-xl shadow-md border border-gray-100 p-3 flex items-center gap-2 hover:shadow-lg transition-shadow">
                                            {badges[1].icon}
                                            <span className="text-xs font-semibold text-primary">{badges[1].label}</span>
                                        </div>
                                        <div className="absolute bottom-4 left-4 bg-white rounded-xl shadow-md border border-gray-100 p-3 flex items-center gap-2 hover:shadow-lg transition-shadow">
                                            {badges[2].icon}
                                            <span className="text-xs font-semibold text-primary">{badges[2].label}</span>
                                        </div>
                                        <div className="absolute bottom-4 right-4 bg-white rounded-xl shadow-md border border-gray-100 p-3 flex items-center gap-2 hover:shadow-lg transition-shadow">
                                            {badges[3].icon}
                                            <span className="text-xs font-semibold text-primary">{badges[3].label}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Decorative blur */}
                            <div className={`absolute -top-4 -right-4 h-32 w-32 rounded-full ${accentColor} opacity-20 blur-3xl`} />
                            <div className="absolute -bottom-4 -left-4 h-24 w-24 rounded-full bg-primary opacity-10 blur-3xl" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <section className="py-24 bg-gray-50 border-y border-gray-100">
                    <div className="mx-auto max-w-7xl px-6 md:px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {/* Ntigi */}
                            <div className="bg-white rounded-2xl p-8 border border-gray-200/80 shadow-sm">
                                <div className="flex items-center justify-center bg-gray-50 rounded-xl w-fit mb-5 px-4 py-3">
                                    <Image 
                                        src="/ntigi1.svg" 
                                        alt="Ntigi logo"
                                        width={100}
                                ...
                                <p className="text-sm text-gray-500 font-semibold uppercase tracking-wider mb-4">Ntigi</p>
                                <ul className="space-y-3 text-sm text-gray-600">
                                    <li className="flex items-start gap-2">
                                        <ChevronRight className="h-4 w-4 text-accent shrink-0 mt-0.5" />
                                        Web, Mobile &amp; Desktop shipping platform
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <ChevronRight className="h-4 w-4 text-accent shrink-0 mt-0.5" />
                                        600+ carrier API integrations
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <ChevronRight className="h-4 w-4 text-accent shrink-0 mt-0.5" />
                                        Automated batch label generation
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <ChevronRight className="h-4 w-4 text-accent shrink-0 mt-0.5" />
                            ...
                            {/* Kassongo */}
                            <div className="bg-white rounded-2xl p-8 border border-gray-200/80 shadow-sm relative">
                                <div className="flex items-center justify-center bg-gray-50 rounded-xl w-fit mb-5 px-4 py-3">
                                    <Image 
                                        src="/kassongo.svg" 
                                        alt="Kassongo logo"
                                ...
                                <p className="text-sm text-gray-500 font-semibold uppercase tracking-wider mb-4">Kassongo</p>
                                <ul className="space-y-3 text-sm text-gray-600">
                                    <li className="flex items-start gap-2">
                                        <ChevronRight className="h-4 w-4 text-accent shrink-0 mt-0.5" />
                            ...
                            <div className="bg-white rounded-2xl p-8 border border-gray-200/80 shadow-sm">
                                ...
                                <p className="text-sm text-gray-500 font-semibold uppercase tracking-wider mb-4">Kovasure</p>
                                <ul className="space-y-3 text-sm text-gray-600">
                                    <li className="flex items-start gap-2">
                                        <ChevronRight className="h-4 w-4 text-accent shrink-0 mt-0.5" />
                                        Real-time policy quotes
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <ChevronRight className="h-4 w-4 text-accent shrink-0 mt-0.5" />
                                        All-risk &amp; named-peril coverage
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <ChevronRight className="h-4 w-4 text-accent shrink-0 mt-0.5" />
                                    ...
                                    <li className="flex items-start gap-2">
                                        <ChevronRight className="h-4 w-4 text-accent shrink-0 mt-0.5" />
                                        Integrated with Ntigi &amp; Kassongo
                                    </li>
                                </ul>
                                <div className="mt-6 pt-6 border-t border-gray-100">
                                    <a
